...
SITES = {
  ...
  "builders218": dict(
    theme="dark", name="218 Builders &amp; Remodelers", short="218 Builders", city="Brainerd, MN",
    title="218 Builders &amp; Remodelers — Custom Homes &amp; Remodeling | Brainerd Lakes, MN",
    desc="218 Builders &amp; Remodelers has served the Brainerd Lakes area for over 50 years. Custom homes, additions, kitchen and bath remodels, residential and commercial construction.",
    nav=[("services","Services"),("work","Projects"),("about","About"),("contact","Contact")],
    cta_href="tel:2188285581", cta_label="Get an estimate",
    eyebrow="Brainerd Lakes · Over 50 Years",
    headline="Built right.<br><em>Built to last.</em>",
    lede="Residential and commercial construction across the Brainerd Lakes area — custom homes, additions, and full kitchen and bath remodels, backed by five decades of craftsmanship.",
    hero_cta="Request an estimate", hero_cta2="See our work",
    hero_note="Brainerd Lakes Chamber member · licensed &amp; insured",
    hero_photo="[ your photo — a finished home or remodel ]",
    badge_num="50+", badge_lbl="Years building in<br>the Brainerd Lakes",
    trust=[("clock","<b>50+ years</b> in business"),("shield","<b>Licensed &amp; insured</b>"),
           ("check","Residential <b>&amp; commercial</b>"),("pin","Brainerd Lakes area")],
    menu_eyebrow="What we build", menu_head="From one room<br>to the whole thing.",
    menu_sub="Every project run by the same crew that's been doing this for decades.",
    menu=[("Custom Homes","start to finish, built to your plan","Quote"),
          ("Additions","more space without moving","Quote"),
          ("Kitchen Remodels","layout, cabinetry, finish work","Quote"),
          ("Bathroom Remodels","full tear-out to tile and trim","Quote"),
          ("Commercial Construction","build-outs and new construction","Quote"),
          ("Decks &amp; Outdoor Living","lake-country ready","Quote")],
    work_head="Five decades of projects.",
    gallery=["[ your best finished build ]","[ a kitchen remodel ]","[ a bathroom ]",
             "[ an addition ]","[ commercial project ]"],
    about_photo="[ your photo — the crew or a jobsite ]",
    about_head="Fifty years in the Lakes.",
    about=["218 Builders &amp; Remodelers has been building in the Brainerd Lakes area for over 50 years — custom homes, additions, remodels and commercial work, all handled by people who live here.",
           "Half a century of referrals doesn't happen by accident. It happens because the work holds up, the crew shows up, and the job gets finished the way it was promised."],
    stats=[("50+","Years building"),("Res &amp; Com","Both handled"),("Local","Brainerd Lakes")],
    quotes=["They built our lake home and the craftsmanship is unreal. Finished on schedule too.",
            "Did our whole kitchen. Clean jobsite every day and the finish work is perfect.",
            "Fair estimate, no surprises, and the crew actually knew what they were doing."],
    visit_head="Let's talk about your project.",
    visit_sub="Tell us what you're planning — new build, addition or remodel — and we'll get you a real estimate.",
    contact_lines=[phone_line("(218) 828-5581","2188285581"),
                   addr_line("Serving the Brainerd Lakes area")],
    visit_note='<p style="color:#7d786f;font-size:.82rem;margin-top:22px">[ Phone number is a placeholder for this preview — your real line goes here before launch. ]</p>',
    hours=[("Monday – Friday","7am – 5pm"),("Saturday","By appointment"),("Sunday","Closed")],
    footer='Custom Homes · Remodeling · Commercial · Brainerd Lakes, MN',
  ),

  "roofing": dict(
    theme="dark", name="Summit Roofing &amp; Exteriors", short="Summit", city="Minnesota",
    title="Summit Roofing &amp; Exteriors — Roofing, Siding &amp; Storm Damage",
    desc="Roofing, siding and storm damage restoration. Free inspections, insurance claim help, workmanship warranty.",
    nav=[("services","Services"),("work","Projects"),("about","About"),("contact","Contact")],
    cta_href="#contact", cta_label="Free inspection",
    eyebrow="Roofing · Siding · Storm Damage",
    headline="A roof that holds.<br><em>A crew that shows up.</em>",
    lede="Full roof replacement, siding, and storm damage restoration, with free inspections, insurance claim support, and a workmanship warranty behind every job.",
    hero_cta="Get a free inspection", hero_cta2="See our work",
    hero_note="Licensed, bonded and insured · workmanship warranty",
    hero_photo="[ your photo — a finished roof ]",
    badge_num="24hr", badge_lbl="Storm damage<br>response",
    trust=[("shield","<b>Licensed &amp; insured</b>"),("check","<b>Free</b> inspections"),
           ("clock","Insurance claims handled"),("star","Workmanship warranty")],
    menu_eyebrow="What we do", menu_head="Roof, siding, and<br>everything after the storm.",
    menu_sub="Every job inspected, documented and warrantied.",
    menu=[("Roof Replacement","tear-off, deck repair, full install","Quote"),
          ("Roof Repair","leaks, flashing, missing shingles","Quote"),
          ("Storm Damage","hail and wind, insurance documented","Free inspection"),
          ("Siding","vinyl, steel, LP smartside","Quote"),
          ("Seamless Gutters","guards and downspouts","Quote"),
          ("Emergency Tarping","24 hour response","Call us")],
    work_head="Roofs we stand behind.",
    gallery=["[ your best finished roof ]","[ tear-off in progress ]","[ siding job ]",
             "[ storm damage before/after ]","[ the crew on site ]"],
    about_photo="[ your photo — crew or truck ]",
    about_head="Local crews. Real warranty.",
    about=["We are a local roofing and exterior company, not a storm chaser passing through. Our crews live here, and we are still here when you need the warranty honored.",
           "Free inspection, an honest assessment, and we handle the insurance paperwork so you are not fighting an adjuster on your own."],
    stats=[("Local","Not storm chasers"),("Free","Inspections"),("Warranty","On workmanship")],
    quotes=["Roof was done in two days and they cleaned up so well you would not know they were here.",
            "They caught hail damage the adjuster missed and got the whole roof covered.",
            "Straight answers, fair price, and they showed up when they said they would."],
    visit_head="Get your free inspection.",
    visit_sub="Storm damage, a leak, or a roof at the end of its life. We will come look and tell you straight.",
    contact_lines=[phone_line("(555) 555-0100","5555550100"), addr_line("Serving [ your service area ]")],
    visit_note='<p style="color:#7d786f;font-size:.82rem;margin-top:22px">[ DEMO SITE — Summit Roofing is not a real company. Built by Blankd Web Studio to show what your roofing site could look like. ]</p>',
    hours=[("Monday – Friday","7am – 6pm"),("Saturday","8am – 2pm"),("Emergency","24/7 storm response")],
    footer='Roofing · Siding · Storm Damage · DEMO SITE by Blankd Web Studio',
  ),

  "concrete": dict(
    theme="light", name="Ironline Concrete &amp; Excavation", short="Ironline", city="Minnesota",
    title="Ironline Concrete &amp; Excavation — Driveways, Flatwork &amp; Site Prep",
    desc="Concrete driveways, patios, garage slabs, foundations and full site prep. Licensed, insured and finished right.",
    nav=[("services","Services"),("work","Projects"),("about","About"),("contact","Contact")],
    cta_href="#contact", cta_label="Get a quote",
    eyebrow="Concrete · Excavation · Site Prep",
    headline="Poured right.<br><em>Stays right.</em>",
    lede="Driveways, patios, garage slabs, foundations and full site prep, done by a crew that finishes concrete for a living, not as a side job.",
    hero_cta="Get a free quote", hero_cta2="See our work",
    hero_note="Licensed and insured · free on-site estimates",
    hero_photo="[ your photo — a finished pour ]",
    badge_num="Free", badge_lbl="On-site estimates<br>no obligation",
    trust=[("shield","<b>Licensed &amp; insured</b>"),("check","<b>Free</b> estimates"),
           ("clock","On schedule, on budget"),("pin","Locally owned")],
    menu_eyebrow="What we pour", menu_head="Flatwork, foundations<br>and everything under them.",
    menu_sub="Prep matters more than the pour. We do both.",
    menu=[("Driveways","tear-out, base prep, finish","Quote"),
          ("Patios &amp; Sidewalks","broom, stamped or exposed","Quote"),
          ("Garage &amp; Shop Slabs","reinforced, cured right","Quote"),
          ("Foundations &amp; Footings","new build and additions","Quote"),
          ("Excavation &amp; Site Prep","grading, base, drainage","Quote"),
          ("Demolition &amp; Removal","old concrete out, new in","Quote")],
    work_head="Work that holds up.",
    gallery=["[ your best driveway ]","[ a stamped patio ]","[ garage slab ]",
             "[ excavation / site prep ]","[ a foundation pour ]"],
    about_photo="[ your photo — the crew or equipment ]",
    about_head="Concrete is all we do.",
    about=["Concrete cracks when the prep is wrong. We grade it, base it and reinforce it properly before a single yard gets poured, because that is the part nobody sees and the part that decides whether it lasts.",
           "Locally owned, licensed and insured, and you get a real number up front."],
    stats=[("Free","On-site estimates"),("Licensed","And insured"),("Local","Owner on every job")],
    quotes=["Best looking driveway on the block and it still looks new three winters later.",
            "They found a drainage problem before pouring that would have wrecked the slab.",
            "Quoted it, poured it, cleaned up. Exactly what they said, no surprises."],
    visit_head="Get a real number.",
    visit_sub="Tell us what you are planning and we will come measure it and give you a straight quote.",
    contact_lines=[phone_line("(555) 555-0100","5555550100"), addr_line("Serving [ your service area ]")],
    visit_note='<p style="color:#7d786f;font-size:.82rem;margin-top:22px">[ DEMO SITE — Ironline is not a real company. Built by Blankd Web Studio to show what your concrete site could look like. ]</p>',
    hours=[("Monday – Friday","7am – 5pm"),("Saturday","By appointment"),("Sunday","Closed")],
    footer='Concrete · Excavation · Site Prep · DEMO SITE by Blankd Web Studio',
  ),

  "outdoor": dict(
    theme="cool", name="Northbound Decks &amp; Outdoor Living", short="Northbound", city="Minnesota",
    title="Northbound Decks &amp; Outdoor Living — Decks, Patios &amp; Outdoor Kitchens",
    desc="Custom decks, screen porches, pergolas and outdoor living spaces built for Minnesota weather.",
    nav=[("services","Services"),("work","Projects"),("about","About"),("contact","Contact")],
    cta_href="#contact", cta_label="Start a project",
    eyebrow="Decks · Porches · Outdoor Living",
    headline="Your backyard,<br><em>finally finished.</em>",
    lede="Custom decks, screen porches, pergolas and full outdoor living spaces, built to handle Minnesota winters and look good doing it.",
    hero_cta="Start your project", hero_cta2="See our builds",
    hero_note="Free design consult · licensed and insured",
    hero_photo="[ your photo — a finished deck ]",
    badge_num="Free", badge_lbl="Design consult<br>and 3D layout",
    trust=[("check","<b>Free</b> design consult"),("shield","<b>Licensed &amp; insured</b>"),
           ("clock","Built for MN winters"),("star","Composite &amp; cedar")],
    menu_eyebrow="What we build", menu_head="From a simple deck<br>to the whole backyard.",
    menu_sub="Designed with you, built by the same crew start to finish.",
    menu=[("Custom Decks","cedar, composite, multi-level","Quote"),
          ("Screen Porches","three-season and four-season","Quote"),
          ("Pergolas &amp; Shade","freestanding or attached","Quote"),
          ("Outdoor Kitchens","built-in grill, counter, storage","Quote"),
          ("Railings &amp; Stairs","cable, glass, aluminum","Quote"),
          ("Deck Restoration","rebuild, reboard, refinish","Quote")],
    work_head="Backyards we have finished.",
    gallery=["[ your best deck build ]","[ a screen porch ]","[ railing detail ]",
             "[ pergola or shade ]","[ outdoor kitchen ]"],
    about_photo="[ your photo — the crew building ]",
    about_head="Built for the way you use it.",
    about=["Every backyard is different. We start with how you actually want to use the space, then design and build around that instead of dropping a rectangle behind your house.",
           "Same crew from design to final railing, using materials that survive a Minnesota freeze-thaw cycle."],
    stats=[("Free","Design consult"),("One crew","Start to finish"),("MN-built","Winter rated")],
    quotes=["They designed exactly what we described and it came out better than the drawing.",
            "Three winters in and the deck still looks brand new. Worth every dollar.",
            "Clean jobsite, on schedule, and the railing work is genuinely beautiful."],
    visit_head="Let us design it with you.",
    visit_sub="Tell us how you want to use the space and we will put together a design and a real number.",
    contact_lines=[phone_line("(555) 555-0100","5555550100"), addr_line("Serving [ your service area ]")],
    visit_note='<p style="color:#7d786f;font-size:.82rem;margin-top:22px">[ DEMO SITE — Northbound is not a real company. Built by Blankd Web Studio to show what your outdoor living site could look like. ]</p>',
    hours=[("Monday – Friday","7am – 5pm"),("Saturday","By appointment"),("Sunday","Closed")],
    footer='Decks · Porches · Outdoor Living · DEMO SITE by Blankd Web Studio',
  ),
}
